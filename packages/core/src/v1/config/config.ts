...
export const Info = Schema.Struct({
  ...
  reducer: Schema.optional(Schema.Literals(["lite", "standard", "ultra"])).annotate({
    description:
      "BJIR response-reduction level (caveman intensity; ponytail always on): 'lite' keeps full sentences, 'standard' is classic caveman (default), 'ultra' is telegraphic. Set via the /reducer command.",
  }),
