...
export class Info extends Schema.Class<Info>("Config.Info")({
  ...
  reducer: Schema.Literals(["lite", "standard", "ultra"]).pipe(Schema.optional).annotate({
    description: "BJIR response-reduction level (caveman intensity; ponytail always on). Set via /reducer.",
  }),
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const names = ["bjir.json", "bjir.jsonc", "config.json", "opencode.json", "opencode.jsonc"]
