...
import { BjirRetrieveTool } from "./bjir-retrieve"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const bjirretrieve = yield* BjirRetrieveTool
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const tool = yield* Effect.all({
          ...
          plan: Tool.init(plan),
          bjirRetrieve: Tool.init(bjirretrieve),
        })
        ...
        return {
          ...
          builtin: [
            ...
            // BJIR CCR: expose bjir_retrieve only when compression is active.
            ...(BjirCompress.enabled() ? [tool.bjirRetrieve] : []),
          ],
          task: tool.task,
          read: tool.read,
        }
