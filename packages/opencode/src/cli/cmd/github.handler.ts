      ...
      function printNextSteps() {
        ...
        prompts.outro(
          [
            ...
            "",
            "   Learn more about the GitHub agent - https://github.com/gogetrekt/bjir",
          ].join("\n"),
        )
      }
...
export const githubRun = Effect.fn("Cli.github.run")(function* (args: { event?: string; token?: string }) {
  ...
  yield* Effect.promise(async () => {
    ...
    try {
      ...
      console.log("bjir session", session.id)
    ...
    async function chat(message: string, files: PromptFiles = []) {
      console.log("Sending message to BJIR...")
    ...
    function footer(opts?: { image?: boolean }) {
      ...
      const shareUrl = shareId ? `[BJIR session](${shareBaseUrl}/s/${shareId})&nbsp;&nbsp;|&nbsp;&nbsp;` : ""
