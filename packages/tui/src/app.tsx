...
import { DialogGain } from "./component/dialog-gain"
import { DialogReducer } from "./component/dialog-reducer"
...
function App(props: { onSnapshot?: () => Promise<string[]>; pluginHost: TuiPluginHost }) {
  ...
  createEffect(() => {
    ...
    if (route.data.type === "home") {
      renderer.setTerminalTitle("BJIR")
      return
    }
  ...
  const appCommands = createMemo(() =>
    [
      ...
      {
        name: "bjir.gain",
        title: "Token savings (gain)",
        slashName: "gain",
        slashAliases: ["savings", "tokens"],
        run: () => {
          dialog.replace(() => <DialogGain />)
        },
        category: "System",
      },
      {
        name: "bjir.reducer",
        title: "Reducer level (caveman)",
        slashName: "reducer",
        slashAliases: ["caveman", "ponytail"],
        run: () => {
          dialog.replace(() => <DialogReducer />)
        },
        category: "System",
      },
      {
      ...
      },
      {
        ...
        title: "Open docs",
        run: () => {
          open("https://github.com/gogetrekt/bjir").catch(() => {})
          dialog.clear()
        },
        category: "System",
      },
  ...
  event.on("installation.update-available", async (evt) => {
    ...
    await DialogAlert.show(
      dialog,
      "Update Complete",
      `Successfully updated to BJIR v${result.data.version}. Please restart the application.`,
    )
