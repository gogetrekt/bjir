...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent BJIR from reading sensitive files",
  "Use {highlight}bjir run{/highlight} for non-interactive scripting",
  "Use {highlight}bjir --continue{/highlight} to resume the last session",
  "Use {highlight}bjir run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}bjir serve{/highlight} for headless API access to BJIR",
  "Use {highlight}bjir run --attach{/highlight} to connect to a running server",
  "Run {highlight}bjir upgrade{/highlight} to update to the latest version",
  "Run {highlight}bjir auth list{/highlight} to see all configured providers",
  "Run {highlight}bjir agent create{/highlight} for guided agent creation",
  "Point a model that can't connect directly through the {highlight}BJIR Gateway{/highlight}",
  "Run {highlight}bjir github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}bjir debug config{/highlight} to troubleshoot configuration",
