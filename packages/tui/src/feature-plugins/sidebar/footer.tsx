      ...
      <Show when={show()}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>Connect a provider to start. BJIR works with 75+ providers.</text>
            <text fg={theme().textMuted}>
              Claude, GPT, Gemini, local models, OpenAI/Anthropic-compatible gateways, and more.
            </text>
